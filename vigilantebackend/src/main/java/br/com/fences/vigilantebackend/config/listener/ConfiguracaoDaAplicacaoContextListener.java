package br.com.fences.vigilantebackend.config.listener;
...
import br.com.fences.vigilantebackend.config.AppConfig;
...
public class ConfiguracaoDaAplicacaoContextListener implements ServletContextListener {
	...
	private static final String APP_NOME = "vigilantebackend";
